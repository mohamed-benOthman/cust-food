...
function LoginFormComponent_form_0_div_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 12);
} }
function LoginFormComponent_form_0_app_error_message_6_Template(rf, ctx) { if (rf & 1) {
...
function LoginFormComponent_form_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("getInput", function LoginFormComponent_form_0_Template_app_simple_input_getInput_4_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.email = $event; })("getInputStatus", function LoginFormComponent_form_0_Template_app_simple_input_getInputStatus_4_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.emailStatus = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "app-simple-input", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("getInput", function LoginFormComponent_form_0_Template_app_simple_input_getInput_5_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.password = $event; })("getInputStatus", function LoginFormComponent_form_0_Template_app_simple_input_getInputStatus_5_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.passwordStatus = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
const _c1 = function () { return ["/forgotPassword"]; };
...
function LoginFormComponent_app_loading_spinner_2_Template(rf, ctx) { if (rf & 1) {
...
class LoginFormComponent {
    ...
    onSubmit(form) {
        ...
        this.authenticationService.login(user).subscribe((res) => {
            ...
            this.router.navigateByUrl('dashboardPage/' + res.id + '/searchRecipe/' + res.id);
        }, (err) => {
            this.error = true;
...
LoginFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginFormComponent, selectors: [["app-login"]], outputs: { login: "login" }, decls: 3, vars: 3, consts: [["class", "form", 3, "submitted", "submit", 4, "ngIf"], ["class", "d-flex justify-content-between", 4, "ngIf"], [4, "ngIf"], [1, "form", 3, "submit"], ["loginForm", "ngForm"], ["class", "loading", 4, "ngIf"], ["type", "form", 1, "d-flex", "justify-content-center"], ["label", "Email", "type", "email", "placeholder", "Email", "icon", "email", "pattern", "^[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,4}$", "required", "true", "name", "email", 3, "getInput", "getInputStatus"], ["label", "Password", "type", "password", "placeholder", "Password", "icon", "Password", "name", "password", "required", "true", 3, "getInput", "getInputStatus"], [3, "message", 4, "ngIf"], [1, "btn-group"], ["type", "submit", 1, "btn", "primary", 3, "disabled"], [1, "loading"], [3, "message"], [1, "d-flex", "justify-content-between"], [1, "register", 3, "routerLink"]], template: function LoginFormComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginFormComponent, [{
    ...
    }], function () { return [{ type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }]; }, { login: [{
...
/* harmony import */ var _login_page_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login-page.component */ "./src/app/pages/login-page/login-page.component.ts");
/* harmony import */ var _logout_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./logout.component */ "./src/app/pages/login-page/logout.component.ts");
...
const routes = [
    { path: 'login', component: _login_page_component__WEBPACK_IMPORTED_MODULE_2__["LoginPageComponent"] },
    { path: 'logout', component: _logout_component__WEBPACK_IMPORTED_MODULE_3__["LogoutComponent"] },
];
...
/* harmony import */ var _components_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/login-form/login-form.component */ "./src/app/pages/login-page/components/login-form/login-form.component.ts");
...
class LoginPageComponent {
    constructor(auth, route, router, nav) {
        this.auth = auth;
        this.route = route;
        this.router = router;
        this.nav = nav;
    ...
    login([username, password] = []) {
        this.auth.login(username, password)
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(error => (this.authErrors = error.error, [])))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["flatMap"])(() => this.nav.routes))
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginPageComponent, [{
    ...
    }], function () { return [{ type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: src_app_services_navigation_service__WEBPACK_IMPORTED_MODULE_4__["NavigationService"] }]; }, null); })();
...
/* harmony import */ var _login_page_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login-page-routing.module */ "./src/app/pages/login-page/login-page-routing.module.ts");
/* harmony import */ var _login_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./login-page.component */ "./src/app/pages/login-page/login-page.component.ts");
/* harmony import */ var _logout_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./logout.component */ "./src/app/pages/login-page/logout.component.ts");
/* harmony import */ var _components_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/login-form/login-form.component */ "./src/app/pages/login-page/components/login-form/login-form.component.ts");
/* harmony import */ var src_app_components_inputs_inputs_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/components/inputs/inputs.module */ "./src/app/components/inputs/inputs.module.ts");
/* harmony import */ var src_app_components_components_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/components/components.module */ "./src/app/components/components.module.ts");
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ "./src/app/pages/login-page/forgot-password/forgot-password.component.ts");
/* harmony import */ var _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./reset-password/reset-password.component */ "./src/app/pages/login-page/reset-password/reset-password.component.ts");
/* harmony import */ var _confirm_user_confirm_user_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./confirm-user/confirm-user.component */ "./src/app/pages/login-page/confirm-user/confirm-user.component.ts");
...
LoginPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function LoginPageModule_Factory(t) { return new (t || LoginPageModule)(); }, imports: [[
            ...
            src_app_components_inputs_inputs_module__WEBPACK_IMPORTED_MODULE_7__["InputsModule"],
            src_app_components_components_module__WEBPACK_IMPORTED_MODULE_8__["ComponentsModule"],
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LoginPageModule, { declarations: [_login_page_component__WEBPACK_IMPORTED_MODULE_4__["LoginPageComponent"], _logout_component__WEBPACK_IMPORTED_MODULE_5__["LogoutComponent"], _components_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_6__["LoginFormComponent"], _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_9__["ForgotPasswordComponent"], _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_10__["ResetPasswordComponent"], _confirm_user_confirm_user_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmUserComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _login_page_routing_module__WEBPACK_IMPORTED_MODULE_3__["LoginPageRoutingModule"],
        src_app_components_inputs_inputs_module__WEBPACK_IMPORTED_MODULE_7__["InputsModule"],
        src_app_components_components_module__WEBPACK_IMPORTED_MODULE_8__["ComponentsModule"]] }); })();
