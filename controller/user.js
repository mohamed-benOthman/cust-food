      ...
      const userFound= await User.findOne({email:email})
        ...
        if (match){
           const token=jwt.sign({
              email: userFound.email},process.env.TOKEN_SECRET,{ expiresIn: '24h'})
          ...
          if (!user){
             ...
             try{
                  ...
                  await  transporter.sendMail({
                     ...
                     html: '<p>Click on this to reset your password<a href="http://127.0.0.1:4200/resetPassword/'+token+'"> link </a> which is valid for 1 hour</p>'      
                  })
         ...
         if (!user){
            ...
            try{
                 ...
                 await  transporter.sendMail({
                    ...
                    html: '<p>Click on this to reset your password<a href="http://127.0.0.1:4200/confirmUser/'+token+'"> link </a> which is valid for 1 hour</p>'      
                 })
                 res.status(200).json('success')
            }
            catch(err){
